...
● Cómo pensar, crear y visualizar funciones 2D.
:::

::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: navy;"}
● Cómo diferenciar funciones 2D (pista: es fácil pero requiere tiempo).
:::

::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: steelblue;"}
● Algunas aplicaciones de la optimización multivariable (descenso de gradiente y campos de gradiente).
:::

::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: teal;"}
● ¡Que el cálculo multivariable es hermoso de ver!
:::
...
::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: #c0392b;"}
● Qué son las funciones 2D.
:::

::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: navy;"}
● Cómo visualizar funciones 2D.
:::

::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: steelblue;"}
● Cómo pensar en las derivadas de funciones 2D.
:::
...
::: {style="display: flex; gap: 0.6em; align-items: flex-start; color: teal;"}
● La definición formal de derivadas parciales basada en límites.
:::
