...
En esta presentación, aprenderás:
   ...
   - El concepto y la definición de una pendiente.

   - Por qué LA pendiente no es útil para muchas funciones.

   - El papel de los límites en el cálculo de la derivada.
...
## La derivada de una constante es 0 (demostración)

::: {.bg style="padding:0em; margin-top:0em; font-size:1.4em;margin-top:0em"}
En esta presentación

  -  Demostrarás lo que dice el título...

  -  Tendrás la oportunidad de ganar más experiencia con la definición de límite de las derivadas.

  -  Aprenderás cómo usar la definición de derivadas en demostraciones.
:::
...
En esta presentación, aprenderás:
  ...
  -  Varias notaciones diferentes de diferenciación.

  -  Algunas ventajas y desventajas de cada notación.
...
::: {.bg style="padding:0em; margin-top:0em; font-size:1.5em;margin-top:0em"}
En este presentación, aprenderás:

  - Cómo interpretar gráficas de derivadas.

  - Que las gráficas de las funciones y sus derivadas no se ven necesariamente iguales.
::: 
...
En esta presentación, has aprendido:

  - [Cómo interpretar gráficas de derivadas.]{style="font-size: 1.5em; line-height: 1.5; color: #c0392b;"}

  - [Que las gráficas de las funciones y sus derivadas no se ven necesariamente iguales.]{style="font-size: 1.5em; line-height: 1.5; color: #1a237e;"}
...
::: {style="display: flex; flex-direction: column; justify-content: center; flex: 1; min-height: 0; padding: 0 2.5em; gap: 1em; font-size: 1.5em;"}

[En esta presentación, aprenderás]{style="color: goldenrod; font-size: 1.1em;"}

- [[Un truco simple para calcular la derivada de expresiones polinómicas.]{style="color: #c0392b;"}]{style="color: #c0392b;"}
...
::: {style="display: flex; flex-direction: column; justify-content: center; flex: 1; min-height: 0; padding: 0 2.5em; gap: 1em; font-size: 1.15em;"}

[En esta presentación aprendiste]{style="color: goldenrod; font-size: 1.1em;"}
...
En esta presentación, aprenderás:
  ...
  -  Que la diferenciación es una operación lineal, lo que significa que los múltiplos escalares y las sumas se pueden separar.

  - Cómo demostrar la linealidad en SymPy.
:::
...
## Derivadas de coseno y seno


::: {.bg style="padding:0em; margin-top:0em; font-size:1.5em;margin-top:0em"}
En esta presentación, aprenderás:

  -  [El "círculo" de las derivadas trigonométricas.]{style="color: #b8860b;font-weight: bold;"}

  - [Intuición geométrica para las derivadas de seno y coseno.]{style="color: #c0392b; "}

  - [Que las demostraciones de derivadas pueden ser tediosas...]{style="color: #1a237e;"}
:::
...
## Derivadas de valor absoluto y raíz cuadrada

::: {.bg style="padding:0em; margin-top:0em; font-size:1.5em;margin-top:0em"}
En esta presentación, aprenderás

  -  Derivadas de dos funciones comunes adicionales.

  - La notación y definición de la función "signum" (signo).

  - Una pista sobre la regla de la potencia.
:::
...
En esta presentación, aprenderás:
  ...
  - La derivada del logaritmo en cualquier otra base.

  - La derivada de exp(x).
:::
...
[En este video, aprenderás]{style="color: goldenrod;"}

- [[Qué hace que un punto sea "crítico."]{style="color: #c0392b;"}]{style="color: #c0392b;"}
...
En este presentación, aprenderás
  ...
  - Un antiguo debate filosófico sobre las matemáticas y la naturaleza.

  - Las posturas dominantes sobre el tema.

  - ¡¡¡LA RESPUESTA VERDADERA DEFINITIVA!!!! (es broma, jajaja)
