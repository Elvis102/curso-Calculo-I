...
## Introducción a la derivada {.title-line}
...
<p style="font-size:24px;color:#444;margin:0 0 7px;line-height:1.5;">
...
::: {style="background:white; border:1px solid #c8ccd1; border-radius:8px; padding:1.5em 1.5em; width:92%; font-size:0.95em; line-height:1.6; box-shadow:0 4px 10px rgba(0,0,0,0.08);"}


::: {style="font-size:1.0em; color:#34495e; line-height:1.7; text-align:justify;margin:0.4em 0; padding:0.4em; background:#f0f4f8; border-radius:6px;"}
Sea $A$ un intervalo de $\mathbb{R}$ $f:A \subset \mathbb{R} \longrightarrow \mathbb{R}$ y $c \in A$ Diremos que $f$ es derivable en $c$ si existe el siguiente límite:
$$
\lim_{x \to c} \frac{f(x)-f(c)}{x-c}
$$

al valor de este límite lo denotamos por $f'(c)$ o $\frac{df}{dx}(c)$ y lo llamamos la derivada de $f$ en $c$.

:::

::: {.fragment .fade-in data-fragment-index=1 style="color:#2c3e50; margin-top:0.1em;font-size:0.8em;"}
[Observación:]{style="color:blue; font-size:1em;font-weight:bold;"}
 Ya probamos que $\displaystyle\lim_{x \to a} g(x)=L$ si y solo si $\displaystyle\lim_{h \to 0} g(a+h)=L$. Por lo tanto, la definición de derivada también se puede escribir como:
 $$f'(c) = \lim_{h \to 0} \frac{f(c+h)-f(c)}{c+h-c}= \lim_{h \to 0} \frac{f(c+h)-f(c)}{h}$$
Igualmente, probamos que $\displaystyle\lim_{x \to a} g(x)=L$ si y solo si $\displaystyle\lim_{x \to a} g(a-h) = L$. Por lo tanto, la definición de derivada también se puede escribir como:
$$f'(c) = \lim_{h \to 0} \frac{f(c-h)-f(c)}{c-h-c}= \lim_{h \to 0} \frac{f(c)-f(c-h)}{h}$$
:::
...
## Relación entre la reta tangente y la derivada {.title-line}
...
::: {style="font-size:1.0em; color:#34495e; line-height:1.7; text-align:justify;margin:0.4em 0; padding:0.4em; background:#f0f4f8; border-radius:6px;"}
Si $f:A \subset \mathbb{R} \longrightarrow \mathbb{R}$ donde $A$ es un intervalo, si $f$ es derivable en todo punto $c \in A$ definimos a la **recta tangente** a la gráfica de $f$ en $A$ en el punto $(c,f(c))$ como la recta que tiene pendiente $f'(c)$, es decir, la recta dada por la siguiente ecuación:
$$
y=f'(x)(x-c)+f(c)
$$
