...
- [Cómo las derivadas hacen que los problemas difíciles sean más fáciles.]{style="color: #c0392b;"}

- [Cómo usar las derivadas para resolver problemas difíciles.]{style="color: navy;"}

- [Cómo resolver problemas complejos utilizando derivadas.]{style="color: teal;"}
...
- [Cómo comparar qué tan rápido crecen las funciones hacia el infinito.]{style="color: #c0392b;"}

- [Una aplicación de la regla de L'Hôpital.]{style="color: navy;"}

- [¡Por qué $e^x$ crece hacia el infinito tan rápido!]{style="color: teal;"}
...
- [Qué es la prueba de la "segunda derivada".]{style="color: #c0392b;"}

- [Cómo usar la prueba de 2.' para evaluar un punto crítico.]{style="color: navy;"}

- [Intuición de por qué funciona la prueba de 2.' (advertencia: no es muy intuitiva).]{style="color: teal;"}

- [Cuándo y por qué la prueba de 2.' es inconclusa.]{style="color: #c0392b;"}
...
- [How to implement the second derivative test in python.]{style="color: #c0392b;"}

- [More about working with sympy.]{style="color: navy;"}
...
- [Qué significa aproximar linealmente una función.]{style="color: #c0392b;"}

- [Por qué son importantes las aproximaciones lineales.]{style="color: navy;"}

- [La fórmula para las aproximaciones lineales (pista: ¡involucra la derivada!).]{style="color: teal;"}
...
- [Las funciones no lineales pueden aproximarse bien mediante funciones lineales si $dx$ es "suficientemente pequeño".]{style="color: #c0392b;"}

- [Las funciones no lineales pueden ser difíciles de calcular, requieren mucho tiempo y son propensas a imprecisiones numéricas.]{style="color: navy;"}

- [Las funciones lineales son fáciles, rápidas y precisas.]{style="color: teal;"}

- [(Las aproximaciones lineales eran extremadamente importantes antes de las computadoras, pero se siguen usando ahora).]{style="color: #c0392b;"}
...
- [Qué son las "raíces" de una función.]{style="color: #c0392b;"}

- [Cómo estimar raíces usando el método de Newton.]{style="color: navy;"}

- [Posibles escenarios de falla y estrategias de mitigación.]{style="color: teal;"}
...
- [Un tipo típico de problema de cálculo de tarea/examen.]{style="color: #c0392b;"}

- [Cómo resolver problemas de maximización.]{style="color: navy;"}

- [Que plantear el problema suele ser la parte difícil.]{style="color: teal;"}
...
- [Adquirir experiencia con problemas simples de optimización.]{style="color: #c0392b;"}

- [Aprender sobre agricultores y jardineros ;)]{style="color: navy;"}
...
- [Ver que pequeños cambios en la descripción del problema pueden llevar a cambios significativos en el resultado.]{style="color: navy;"}
...
- [El algoritmo de descenso de gradiente.]{style="color: navy;"}
