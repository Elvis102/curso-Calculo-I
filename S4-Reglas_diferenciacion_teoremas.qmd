...
## Linealidad de la diferenciación (demostración)

::: {.bg style="padding:0em; margin-top:0em; font-size:1.7em;margin-top:0em"}

En este presentación, aprenderás

   - La demostración de que la diferenciación es una operación lineal.
:::

## ¿Porqué la diferenciación es lineal? {.title-line}

::: {style="display: flex; flex-direction: column; justify-content: center; align-items: center; flex: 1; min-height: 0; padding: 0.5em 2em; gap: 0.4em; font-size: 0.83em;"}
...
## Teorema: La derivabilidad implica continuidad

::: {.bg style="padding:0em; margin-top:0em; font-size:1.4em;margin-top:0em"}
En esta presentación, aprenderás:

  -  Que si una función es derivable en un punto, entonces también es continua en ese punto.

  -  La demostración de esa afirmación.

  -  La respuesta a la pregunta de si la continuidad implica derivabilidad.
:::


## El Teorema {.title-line}

::: {style="display: flex; flex-direction: column; justify-content: center; flex: 1; min-height: 0; padding: 0 2em; font-size: 1.3em; font-weight: bold; color: #B8860B; line-height: 1.5;"}
Si la derivada existe en un punto $x_0$, entonces la función es continua en $x_0$.
:::

## Recordatorio sobre límites {.title-line}

::: {style="display: flex; flex-direction: column; justify-content: center; align-items: center; flex: 1; min-height: 0; gap: 2.5em; font-size: 1.3em;"}
...
::: {style="display: flex; flex-direction: column; justify-content: center; align-items: center; flex: 1; min-height: 0; padding: 0.5em 2em; gap: 0.6em; font-size: 0.9em; text-align: center;"}
...
::: {.fragment .fade-in data-fragment-index=3 style="display: flex; flex-direction: row; align-items: center; justify-content: center; gap: 0.5em;"}
...
En este presentación, aprenderás
   ...
   -  ¡La regla de la cadena! Una de las reglas de derivación más importantes.

   -  La intuición de por qué funciona la regla de la cadena.
:::   
...
::: {style="width: 90%; display: flex; flex-direction: column; align-items: center; gap: 0.8em; padding: 1em 3em; font-size: 1.5em;"}
...
$[ {\color{goldenrod}f}({\color{red}g}({\color{teal}x})) ]' \;=\; {\color{goldenrod}f}'({\color{red}g}({\color{teal}x}))\,{\color{red}g}'({\color{teal}x})$
:::
::: {style="font-size: 1.2em; display: flex; flex-direction: column; gap: 0.3em; align-items: center; margin-top: 0.4em;"}
...
${\color{goldenrod}z} = {\color{goldenrod}f}({\color{red}y})$
:::
::: {style="font-size: 1.5em; margin-top: 0.3em;"}
...
::: {style="display: flex; flex-direction: column; align-items: flex-start; gap: 0.5em; font-size: 1.3em;"}
...
:::
::: {style="display: flex; flex-direction: column; gap: 0.25em; font-size: 0.9em; padding-top: 0.2em;"}
${\color{red}y} = {\color{red}g}({\color{teal}x})$
${\color{goldenrod}z} = {\color{goldenrod}f}({\color{red}y})$
:::
:::
...
::: {.fragment .fade-in data-fragment-index=1 style="font-size: 1.3em;"}
$[ {\color{goldenrod}f}({\color{red}g}({\color{teal}x})) ]' = {\color{goldenrod}f}'({\color{red}g}({\color{teal}x}))\,{\color{red}g}'({\color{teal}x})$
:::

<!-- Fragmento 2: Sustituciones y + notación Leibniz -->
::: {.fragment .fade-in data-fragment-index=2 style="font-size: 1.1em; display: flex; flex-direction: column; gap: 0.3em; align-items: center; margin-top: 0.5em;"}
${\color{goldenrod}y} = {\color{red}g}({\color{teal}x})$
${\color{goldenrod}z} = {\color{goldenrod}f}({\color{red}y})$
:::
::: {.fragment .fade-in data-fragment-index=3 style="font-size: 1.1em; margin-top: 0.4em;"}
$\frac{{\color{goldenrod}dz}}{{\color{teal}dx}} = \frac{{\color{goldenrod}dz}}{{\color{red}dy}} \cdot \frac{{\color{red}dy}}{{\color{teal}dx}}$
:::

<!-- Fragmento 4: Notación Leibniz con emojis -->
::: {.fragment .fade-in data-fragment-index=4 style="font-size: 1.1em; margin-top: 1em;"}
$\frac{{\color{goldenrod}dz}}{{\color{teal}dx}} = \frac{{\color{goldenrod}dz}}{{\color{red}dy}} \cdot \frac{{\color{red}dy}}{{\color{teal}dx}}$
:::

::: {.fragment .fade-in data-fragment-index=5 style="font-size: 1.1em; margin-top: 0.5em;"}
...
::: {.fragment .fade-in data-fragment-index=0 style="font-size: 1.3em; color: goldenrod; margin-bottom: 0.5em;"}
En esta presentación, aprenderás
:::

::: {.fragment .fade-in data-fragment-index=1 style="font-size: 1.15em; margin-top: 0.8em;"}
- Otra regla extraña que solo tienes que memorizar...
:::

::: {.fragment .fade-in data-fragment-index=2 style="font-size: 1.15em; margin-top: 0.5em; color: darkblue;"}
- ¡La regla del cociente, que es súper importante!
:::

::: {.fragment .fade-in data-fragment-index=3 style="font-size: 1.15em; margin-top: 0.5em; color: teal;"}
- Una aplicación de la regla de la cadena, para demostrar la regla del cociente.
:::
...
::: {.fragment .fade-in data-fragment-index=1}
- La diferencia entre una función "implícita" y una función "explícita".
:::
...
● Recordatorios de algunas reglas de cálculo
:::

::: {style="color: navy; margin-bottom: 0.3em;"}
● Demostraciones de esas reglas usando diferenciación implícita.
:::

::: {style="color: navy;"}
● ¡Más sobre la total genialidad de la diferenciación implícita!
:::
...
## DesafíosCode Diferenciación implicita {background-color="#111111"}

::: {style="font-size: 1.5em; padding: 0.5em 1em; line-height: 1.8;"}

::: {style="color: #5bc8d4; font-weight: bold; margin-bottom: 0.4em;"}
En este video, aprenderás
:::

::: {style="color: #5bc8d4; margin-bottom: 0.3em;"}
● Cómo implementar la diferenciación implícita en sympy.
:::

::: {style="color: #f5d130; margin-bottom: 0.3em;"}
● Cómo visualizar funciones implícitas en sympy.
:::

::: {style="color: #f0a050; margin-bottom: 0.3em;"}
● ¡Más sobre lo complicada que puede ser la diferenciación implícita!
:::

::: {style="color: #e8a07a;"}
● Más sobre trabajar con números simbólicos vs. de precisión finita.
:::
...
::: {style="font-size: 1.5em; padding: 0.5em 1em; line-height: 1.6;"}

::: {style="color: goldenrod; font-weight: bold; margin-bottom: 0.5em;font-size: 1.5em;"}
En esta presentación, aprenderás
:::

::: {style="color: #c0392b; margin-bottom: 0.3em;"}
● Notaciones para derivadas de orden superior.
:::
...
::: {style="display: flex; flex-direction: row; gap: 2.5em; align-items: flex-start; margin-top: 1.8em; font-size: 1.35em;"}

::: {style="flex: 1.5;"}
::: {style="color: goldenrod; margin-bottom: 0.6em;"}
En este video, aprenderás
:::
...
::: {style="color: navy;"}
● Cuándo y cómo aplicar la regla.
:::
:::

::: {.fragment .fade-in data-fragment-index="1" style="flex: 1; border: 2px solid #333; border-radius: 4px; padding: 0.6em 1em; font-size: 0.85em; line-height: 1.9;"}
**Posibles grafías:**
...
::: {style="font-size: 1.4em; margin-top: 1.2em; line-height: 1.7;"}
::: {style="color: goldenrod; margin-bottom: 0.4em;"}
En esta presentación, aprenderás
:::

::: {style="color: #c0392b;"}
● Intuición geométrica del teorema de Rolle.
:::

::: {style="color: navy;"}
● La definición formal del teorema.
:::

::: {style="color: navy;"}
● Las condiciones para que el teorema de Rolle sea válido.
:::
:::
...
::: {style="display: flex; flex-direction: column; justify-content: center; flex: 1; min-height: 0; padding: 0.5em 2.5em; gap: 0.65em; font-size: 1.1em;font-weight: bold;"}

::: {style="color: goldenrod; font-weight: bold; margin-bottom: 0.2em;"}
En este video, aprenderás
:::
...
::: {style="color: navy;"}
● La definición formal del teorema, y por qué su nombre es confuso.
:::

::: {style="color: teal;"}
● La relación entre el teorema del valor medio y el teorema de Rolle.
:::

::: {style="color: teal;"}
● Las condiciones de validez del teorema del valor medio.
:::
