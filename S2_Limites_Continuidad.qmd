...
Se dice que $k \in \mathfrak{R}$ es un <span style="color: red;">cero</span> de $f: \mathfrak{R} \to \mathfrak{R}$ si $\mathbf{f(k) = 0}$. En términos geométricos, los <span style="color: red;">ceros</span> de "$f$" son los puntos en que la gráfica de "$f$" <span style="color: red;">toca al eje de abscisas</span>.
</p>
...
<p style="color: black; font-weight: bold;">
Si $k \in \mathfrak{R}$ es un <span style="color: red;">cero</span> de "$f$", se dice es una <span style="color: red;">raíz</span> de la ecuación $f(x) = 0$.
</p>
...
plt.legend()
```
<div style="margin-top: 10px; font-size: 0.65em;">
<p>
<span style="color: magenta; font-weight: bold;">Por ejemplo</span>, si $f(x) = x^2 - 5x + 6$, los únicos <span style="color: red;">ceros</span> de "$f$" son $2$ y $3$
</p>
...
<p>
<span style="color: magenta; font-weight: bold;">Por ejemplo</span>, si $g(x) = e^x$, la función "$g$" carece de <span style="color: red;">ceros</span>, pues $\forall x \in \mathbb{R}$ sucede que $g(x) = e^x > 0$.
</p>
...
Demostrar la existencia de al menos una raíz real negativa para el polinomio $P(x)=x4−4x2−1$. en el $[-3, 0]$.
:::
...
<div style="margin-top: 15px; font-size: 0.75em; color: black; font-weight: bold;">
...
:::
::: {.column width="50%"} 
<div style="background-color: yellow; padding: 15px; border: 2px solid black; flex-grow: 1; font-size: 0.75em; max-width: 400px;margin-top:3em">
<p style="margin: 0;">
...
<div style="margin-top: 20px; font-size: 0.75em; color: black; font-weight: bold;">
<p style="text-align: justify;">
