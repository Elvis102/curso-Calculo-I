...
::: {.bg style="padding:0em; margin-top:0em; font-size:0.8em;margin-top:-1em"}
**Recuerda:** al escribir $x\to c$ queremos indicar que $x$ se aproxima a $c$ indistintamente por la derecha o por la izquierda.

Además, Si los límites laterales de **$f$** en **$c$** son distintos diremos que **$f$** [no tiene límite]{.alert} en el punto **$c$**.
:::

::: {.bg style="padding:0em; margin-top:-0.9em; font-size:0.75em;"}
