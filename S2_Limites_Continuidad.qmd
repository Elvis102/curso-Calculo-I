...
El límite se enfoca en el **comportamiento** de la función en las **proximidades** de un punto, no necesariamente en el valor exacto de la función en ese punto.
  ...
  * **Existencia:** Un límite puede existir incluso si la función no está definida en el punto en cuestión. Por ejemplo, en una función con un agujero. .
...
$\lim_{x \to 26} \frac{3 \cdot (x-2)^2 + (x-2)}{(x-2)} = \lim_{x \to 26} (3 \cdot (x-2) + 1)$
...
::: {.fragment}
* Si $f(x) = 2x+3$, entonces: $\lim_{x \to 5} f(x) = 13 = f(5)$
...
::: {.fragment}
* Si $f(x) = x^2+7$, entonces: $\lim_{x \to -3} f(x) = 16 = f(-3)$
...
::: {.fragment}
* Si $f(x) = 3x^3-x$, entonces: $\lim_{x \to 2} f(x) = 3 \cdot 2^3 - 2 = 22$
...
::: {.fragment}
::: {.bg style="background: none; font-size:0.9em;margin-top:-1.5em;"}
$\lim_{x \to -5} f(x) = -125$ *PL*: Si $x \to -5$, entonces  $\Rightarrow f(x) = x^3 \to (-5)^3 = -125$
:::
:::
...
::: {.fragment}
::: {.bg style="background: none; font-size:0.9em;margin-top:-1.5em;"}
$\lim_{x \to 2} f(x) = 3$ *PL*: Si $x \to 2$, entonces  $\Rightarrow f(x) = 2^x-1 \to 2^2-1 = 3$
:::
:::
...
::: {.fragment}
::: {.bg style="background: none; font-size:0.9em;margin-top:-1.5em;"}
$\lim_{x \to 4} f(x) = 17$ *PL*: Si $x \to 4$, entonces  $\Rightarrow f(x) = x^2+1 \to 4^2+1 = 17$
:::
:::
