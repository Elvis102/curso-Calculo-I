...
::: {.bg style="padding:0em; font-size: 0.6em;font-weight: bold;"}
Como de [Precio $\overset{f}\longrightarrow$ cantidad]{.alert} sólo sabemos que $f(2)=12$ y $f(5)=8$, entonces es [imposible]{.blue} conocer $f(3)=?$.
[Estimaciones lineales]{.alert} $\Longrightarrow$ consideremos que [Precio $\overset{f}\longrightarrow$ cantidad]{.alert} es la recta que pasa por los puntos $(2, 12)$ y $(5, 8)$, por lo que:
$$
\left.
\begin{array}{l}
...
::: {.fragment fragment-index="2"}
::: center
![](Images/f-21.png){width="73%"}
:::
:::

::: {.fragment fragment-index="3"}
::: center
![](Images/f-22.png){width="73%"}
:::
:::

::: {.fragment fragment-index="4"}
::: center
![](Images/f-23.png){width="73%"}
:::
:::

::: {.fragment fragment-index="5"}
::: center
![](Images/f-24.png){width="73%"}
:::
:::

::: {.fragment fragment-index="7"}
::: center
![](Images/f-25.png){width="82%"}
:::
:::
